...
CREATE TABLE routinginfo (id INT NOT NULL, module_id INT DEFAULT NULL, uri TEXT NOT NULL, handler TEXT NOT NULL, methods TEXT NOT NULL, PRIMARY KEY(id));
CREATE INDEX IDX_92043ED9AFC2B591 ON routinginfo (module_id);
COMMENT ON COLUMN routinginfo.methods IS '(DC2Type:simple_array)';
